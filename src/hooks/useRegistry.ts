...
export function useRegistry() {
  ...
  const updateThankYouCard = useCallback(async (id: string, updates: Partial<{ label: string; mailingName: string; address: string; note: string; hint: string; status: ThankYouCardStatus; addressVerified: boolean }>) => {
